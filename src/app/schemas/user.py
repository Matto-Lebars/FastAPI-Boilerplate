...
from ..core.schemas import AuditSchema, PersistentDeletion, TimestampSchema, UUIDSchema
...
class User(TimestampSchema, UserBase, UUIDSchema, PersistentDeletion, AuditSchema):
